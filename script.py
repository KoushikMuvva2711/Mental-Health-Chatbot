# Create templates directory and move the HTML file
import os

# Create templates directory
os.makedirs('templates', exist_ok=True)

# Move the enhanced HTML to templates directory
import shutil
shutil.move('enhanced_index.html', 'templates/enhanced_index.html')

# Create a simplified version of the enhanced backend that uses the correct template path
updated_backend = """# Enhanced backend.py with data storage - preserving original functionality
import os
import sqlite3
...
# Update the enhanced app with correct template path
...
print("📋 HTML moved to templates/enhanced_index.html")
print("🔧 Backend updated to use correct template path")

# List all created files
print("\n📦 Complete project structure:")
files = [
    "enhanced_app.py - Enhanced backend preserving your logic + data storage",
    "templates/enhanced_index.html - Beautiful, dynamic frontend",
